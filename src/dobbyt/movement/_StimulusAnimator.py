...
class StimulusAnimator(dobbyt._DobbyObject):
    ...
    See :class:`~dobbyt.movement.CircularTrajectoryGenerator` for an example trajectory generator.
    """
    ...
    def position_shift(self):
        """
        (x,y) coordinates. The coordinates generated by the :attr:`~dobbyt.movement.StimulusAnimator.trajectory_generator`
        will be shifted by this amount before updating :attr:`~dobbyt.movement.StimulusAnimator.animated_object`
